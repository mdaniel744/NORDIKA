...
export const dictionaries: Record<Locale, Dictionary> = {
  de: {
    ...
    home: {
      eyebrow: "Containerlösungen aus Mainz",
      ...
      trust: ["Persönliche Beratung", "Geprüfte Container", "Deutschlandweite Lieferung"],
      ...
      aboutEyebrow: "Über NORDIKA Container",
      aboutTitle: "Erfahrung, die bei jedem Projekt zählt.",
      aboutText: "Wir begleiten Containerprojekte mit klarer Beratung, sorgfältig ausgewähltem Bestand und verlässlicher Logistik.",
    ...
    footer: { summary: "Neue und gebrauchte Container, individuelle Umbauten und verlässliche Logistik – persönlich betreut von der Auswahl bis zur Aufstellung.", products: "Produkte", service: "Service", company: "Unternehmen", legal: "Rechtliches", rights: "Alle Rechte vorbehalten.", notice: "Preise und Verfügbarkeit vorbehaltlich finaler Bestätigung." },
  },
  en: {
    ...
    footer: { summary: "New and used containers, custom conversions and reliable logistics, personally managed from selection to installation.", products: "Products", service: "Service", company: "Company", legal: "Legal", rights: "All rights reserved.", notice: "Prices and availability are subject to final confirmation." },
  },
  nl: {
    ...
    footer: { summary: "Nieuwe en gebruikte containers, maatwerk en betrouwbare logistiek, persoonlijk begeleid van keuze tot plaatsing.", products: "Producten", service: "Service", company: "Bedrijf", legal: "Juridisch", rights: "Alle rechten voorbehouden.", notice: "Prijzen en beschikbaarheid onder voorbehoud van definitieve bevestiging." },
  },
  it: {
    ...
    footer: { summary: "Container nuovi e usati, trasformazioni su misura e logistica affidabile, seguiti personalmente dalla scelta alla posa.", products: "Prodotti", service: "Servizi", company: "Azienda", legal: "Note legali", rights: "Tutti i diritti riservati.", notice: "Prezzi e disponibilità soggetti a conferma finale." },
  },
  cs: {
    ...
    home: { eyebrow: "Kontejnerová řešení z Mohuče", title: "Správný kontejner. Jasné poradenství. Bezpečné dodání.", intro: "Nové i použité námořní, skladové, chladicí a speciální kontejnery pro firmy, veřejný sektor i soukromé zákazníky.", browse: "Prohlédnout kontejnery", request: "Osobní nabídka", trust: ["Osobní poradenství", "Kontrolované kontejnery", "Doprava po celém Německu"], finderEyebrow: "Rychlý výběr", finderTitle: "Jaký kontejner potřebujete?", finderText: "Vyberte použití, velikost a stav. Katalog zobrazí vhodné dostupné modely.", categoriesEyebrow: "Sortiment", categoriesTitle: "Kontejnery pro každé využití", featuredEyebrow: "Ihned k dispozici", featuredTitle: "Vybrané kontejnery", featuredText: "Aktuální skladové modely s přehlednými cenami a technickými údaji.", processEyebrow: "Snadné plánování", processTitle: "Od výběru po usazení", process: [{ title: "Vyberte kontejner", text: "Filtrujte sklad nebo požádejte o osobní poradenství." }, { title: "Naplánujte dopravu", text: "Prověříme příjezd, podklad, termín a požadavky na jeřáb." }, { title: "Bezpečné usazení", text: "Kontejner odborně umístíme na dohodnuté místo." }], aboutEyebrow: "O NORDIKA Container", aboutTitle: "Zkušenosti důležité pro každý projekt.", aboutText: "Zajišťujeme kontejnerové projekty s jasným poradenstvím, pečlivě vybraným skladem a spolehlivou logistikou.", learnMore: "Více o nás", ctaTitle: "Máte konkrétní projekt?", ctaText: "Stručně popište svou potřebu. Navrhneme vhodné řešení a transparentní nabídku." },
    ...
    footer: { summary: "Nové a použité kontejnery, úpravy na míru a spolehlivá logistika s osobním přístupem od výběru po usazení.", products: "Produkty", service: "Služby", company: "Společnost", legal: "Právní informace", rights: "Všechna práva vyhrazena.", notice: "Ceny a dostupnost podléhají konečnému potvrzení." },
  },
  es: {
    ...
    footer: { summary: "Contenedores nuevos y usados, transformaciones a medida y logística fiable, con atención personal desde la elección hasta la instalación.", products: "Productos", service: "Servicios", company: "Empresa", legal: "Legal", rights: "Todos los derechos reservados.", notice: "Precios y disponibilidad sujetos a confirmación final." },
  },
};
